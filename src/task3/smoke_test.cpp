...
static constexpr auto r_10_30 = cls03::range<10,30>();
static constexpr auto r_30_50 = cls03::range<30,50>();
static constexpr auto r_40_70 = cls03::range<40,70>();
...
static_assert(r_30_50.size() == 20);
static_assert(r_30_50(5) == 35);
static_assert(r_30_50(19) == 49);
static_assert(r_30_50(20) == size_t(-1));
static_assert(r_30_50(25) == size_t(-1));
...
static_assert(std::is_same_v<std::decay_t<decltype(r_10_30)>, cls03::range<10,30>>);

// склеенный диапазон - тоже диапазон
static_assert(std::is_same_v<std::decay_t<decltype(r_10_50)>, cls03::range<10,50>>);
#endif
...
static_assert(
    std::is_same_v<
        decltype(cls03::range<1,2>() + cls03::range<3,4>() + cls03::range<5,6>()),
        cls03::concat<
            cls03::concat<
                cls03::range<1,2>,
                cls03::range<3,4>>,
...
static_assert(
    std::is_same_v<
        decltype((cls03::range<1,2>() + cls03::range<3,4>()) + (cls03::range<5,6>() + cls03::range<7,8>())),
        cls03::concat<
            cls03::concat<
                cls03::concat<
                    cls03::range<1,2>,
...
static_assert(
    std::is_same_v<
        decltype((cls03::range<1,2>() + cls03::range<3,4>()) + (cls03::range<4,6>() + cls03::range<7,8>())),
        cls03::concat<
            cls03::concat<
                cls03::range<1,2>,
                cls03::range<3,6>>,
